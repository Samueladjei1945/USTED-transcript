...
from .models import Student, Admin, Semester, Course, TranscriptRequest
...
class TranscriptRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'student_id', 'student_name', 'purpose', 'transcript_type', 'momo_name', 'momo_number', 'telephone', 'address', 'total_amount', 'notes', 'payment_reference', 'status', 'created_at', 'reviewed_at']