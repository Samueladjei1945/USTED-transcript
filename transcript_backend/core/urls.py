...
urlpatterns = [
    ...
    path('admin/requests/<int:req_id>/upload-document/', views.upload_document, name='upload_document'),
    ...
    path('student/tickets/', views.student_tickets, name='student_tickets'),
    path('student/tickets/mark-read/', views.student_mark_tickets_read, name='student_mark_tickets_read'),
    path('admin/tickets/', views.admin_tickets, name='admin_tickets'),
    path('admin/tickets/<int:ticket_id>/respond/', views.admin_respond_ticket, name='admin_respond_ticket'),
    path('admin/tickets/<int:ticket_id>/mark-viewed/', views.admin_mark_ticket_viewed, name='admin_mark_ticket_viewed'),
